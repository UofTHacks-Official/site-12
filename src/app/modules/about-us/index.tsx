  ...
  return (
    <AboutUsModuleContainer>
        ...
        <LeftContainer>
          <SpaceGrotesk>
              <h1>
                  Canada’s <span className="highlight">first</span> <br /> student-run hackathon
              </h1>
          </SpaceGrotesk>
          <AboutGraphic src="/assets/about/Graphic.svg" alt="Gradient Graphic" width={75} height={75}/>
          <Manrope>
        ...
        <ImagesContainer>
            <StyledImage src="/assets/about/about-1.svg" alt="UofT Hacks executive speaking to a crowd" width={160} height={160} />
            <StyledImage src="/assets/about/about-2.svg" alt="UofT Hacks sponsors" width={350} height={200} />
            <StyledImage src="/assets/about/about-3.svg" alt="UofT Hacks executive speaking to a crowd" width={400} height={200} />
            <Image src="/assets/about/Keys.svg" alt="Keys Icon" width={75} height={170} />
        </ImagesContainer>
    </AboutUsModuleContainer>
  );
};
